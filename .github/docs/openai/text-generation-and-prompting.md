...
[Use the Playground to develop and iterate on prompts.](/https://platform.openai.com/playground)[

Generate JSON data with Structured Outputs

[Ensure JSON data emitted from a model conforms to a JSON schema.](https://platform.openai.com/docs/guides/structured-outputs)[
